...
```
  ...
  Prefix: 100.68.1.0/24              (pre-configured trainer)
```
...
| ASN lokal (UMM) | `65010` |
| Prefix UMM yang diiklankan | `100.68.1.0/24` |
...
| `PfxSnt: 0` — prefix UMM tidak terkirim | Route `100.68.1.0/24` tidak ada di routing table | Cek: `show ip route 100.68.1.0/24` — harus ada null/blackhole route |
